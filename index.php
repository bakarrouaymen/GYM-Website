...
<html lang="en">
  <head>
    ...
    <title>FITUIC #1 GYM In Morocco</title>
  </head>
  <body>
    <nav>
      <div class="nav__logo">
      ...
      <ul class="nav__links">
        ...
        <li class="link"><a href="#pricingid">Pricing</a></li>
        <li class="link"><a href="#reviews">Reviews</a></li>
        <li class="link"><a href="additional/contactUs.php">Contact Us</a></li>
      </ul>
      <button class="btn"><a href="additional/reservation.php">Book A Class</a></button>
    </nav>
    ...
    <header class="section__container header__container">
      <div class="header__content">
        ...
        <button class="btn"><a href="#explore">Get Started</a></button>
      </div>
    ...
    <section class="section__container explore__container">
      <div class="explore__header">
        <h2 class="section__header" id ="explore">EXPLORE OUR PROGRAM</h2>
      </div>
      <div class="explore__grid">
        <div class="explore__card">
          ...
          <a href="additional/payment.php">Join Now <i class="ri-arrow-right-line"></i></a>
        </div>
        <div class="explore__card">
    ...
    <section class="section__container price__container">
      <h2 class="section__header"  id="pricingid">OUR PRICING PLAN</h2>
      <p class="section__subheader">
      ...
      <div class="price__grid">
        <div class="price__card">
          ...
          <button class="btn price__btn"><a href="additional/payment.php">Join Now</a></button>
        </div>
        <div class="price__card">
          <div class="price__card__content">
            <h4>Weekly Plan</h4>
          ...
          <div class="review__footer">
            <div class="review__member">
              ...
              <div class="review__member__details">
                <h4>Anass Achraoui</h4>
                <p>7 Times MR.Olympia Champion</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <footer class="section__container footer__container">
      ...
      <div class="footer__col">
        <h4>Company</h4>
        <a href="https://www.mesproteines.ma/">Affiliate Stores</a>
        <a href="https://row.gymshark.com/">Partnership</a>
      </div>
      <div class="footer__col">
        <h4>About Us</h4>
        <a href="https://www.anytimefitness.co.in/blog/">Blogs</a>
        <a href="https://en.wikipedia.org/wiki/Mr._Olympia">Careers</a>
      </div>
      <div class="footer__col">
        <h4>Contact</h4>
        <a href="additional/contactUs.php">Contact Us</a>
        <a href="https://www.calculator.net/bmi-calculator.html">BMI Calculator</a>
      </div>
    </footer>
    <div class="footer__bar">
      Copyright © 2024 FITUIC. All rights reserved.
    </div>
  </body>
</html>
